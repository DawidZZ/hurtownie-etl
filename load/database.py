...
fact_event = Table('tmp_fact_event', tmp_metadata,
                   Column('id', Integer, primary_key=True),
                   Column('time_id', Integer, ForeignKey('tmp_dim_time.id')),
                   Column('location_id', Integer, ForeignKey('tmp_dim_location.id')),
                   Column('source_id', Integer, ForeignKey('tmp_dim_source.id')),
                   Column('flood_cause_id', Integer, ForeignKey('tmp_dim_flood_cause.id')),
                   Column('event_type_id', Integer, ForeignKey('tmp_dim_event_type.id')),
                   Column('wfo_id', Integer, ForeignKey('tmp_dim_wfo.id')),
                   Column('population_density_id', Integer, ForeignKey('tmp_dim_population_density.id')),
