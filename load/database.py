...
fact_event = Table('fact_event', metadata,
                   ...
                   Column('location_id', Integer,
                          ForeignKey('dim_location.id')),
                   Column('source_id', Integer, ForeignKey('dim_source.id')),
                   Column('flood_cause_id', Integer,
                          ForeignKey('dim_flood_cause.id')),
                   Column('event_type_id', Integer,
                          ForeignKey('dim_event_type.id')),
                   Column('wfo_id', Integer, ForeignKey('dim_wfo.id')),
                   Column('population_density_id', Integer,
                          ForeignKey('dim_population_density.id'))
                   )
