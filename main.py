...
from transform.transform import drop_rows_with_missing_values, fill_missing_values, insert_population_density_to_main_dataset, drop_unused_columns, create_derived_columns
import pandas as pd
...
required_non_derived_columns = [
    'YEAR', 'MONTH_NAME',  'BEGIN_DAY',
    'STATE', 'CZ_NAME', 'EVENT_TYPE', 'WFO', 'INJURIES_DIRECT',
    'INJURIES_INDIRECT', 'DEATHS_DIRECT', 'DEATHS_INDIRECT'
]

required_derived_columns = ['population_density', 'magnitude_group', 'damage_group', 'duration', 'injuries_total', 'deaths_total', 'MONTH', 'QUARTER', 'DAMAGE_PROPERTY', 'BEGIN_LAT', 'BEGIN_LON' ]

required_columns = required_non_derived_columns + required_derived_columns
...
def main():
    ...
    storm_details_data = drop_rows_with_missing_values(storm_details_data, required_non_derived_columns)
